...
class HistoryLoader():
    ...
    def load_date_lookup(self):
        # Fills the date_lookup in the silver layer
        # This is a calendar dimension in our model
        # Prepared 20 years date data table
        # All companies have this customized
        # We are brining data from the JSON file
